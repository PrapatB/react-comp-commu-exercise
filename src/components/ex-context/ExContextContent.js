...
export default exerciseContent(
  ...
  () => <div>
      ...
      >
        <TreeNode title="src" key="src">
          <TreeNode title="components" key="components">
            <TreeNode title="ex-context" key="ex-context">
    ...
    <p>
      Using <Code>Context</Code> strategy described in <a href="https://www.javascriptstuff.com/component-communication/#8-context" target="_blank">https://www.javascriptstuff.com/component-communication/#8-context</a>
    </p>
  </div>,
  () => <Tabs />
);
